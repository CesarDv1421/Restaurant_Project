...
import ToggleAditionalButton from "./ToggleAditionalButton";
    ...
    <div className="foodDescription">
      <div className="foodDescriptionInfo">
        ...
        <div className="titleAvailablePrice">
          ...
          {(extras || ingredientes ) && (
            <>
              <p>
                Si desea agregar un adicional o quitar un ingrediente, haz{" "}
                <button onClick={() => setModalIsOpen(true)}>Click aqui</button>{" "}
              </p>
                ...
                <div className="contentModal">
                  <div>
                    <div className="foodVariant">
                      ...
                      <h5>
                        *La informacion obtenida a traves de la nota no
                        garantiza la posibilidad de el cambio o la modificacion
                        del plato
                      </h5>
                      ...
                      <div>
                        <button
                          className="aggOrder"
                          onClick={() =>
                            viewOrder(quanty, variants, additional)
                          }
                        >
                          Ver pedido
                        </button>
      ...
      <form onSubmit={createOrder} className="foodDescriptionManagement">
        ...
        <div className="quanty">
          <div className="quantyButton minus" onClick={() => substractQuanty()}>
            <FontAwesomeIcon icon={faMinus} />
          </div>
